        ...
        <div class="py-5 w-100">
            <div class="row">
                ...
                <div class="col-lg-12 mb-3">
                    <img class="img-fluid" src="<?php echo base_url($course['course_img']) ?>" alt="">
                </div>
                <div class="col-lg-12 mb-3">
                    <h5>
                ...
                ?>
                    <div class="col-lg-12 text-center">
                        ...
                        <div class="row my-3">
                            <?php
                            foreach ($TED as $key => $row) {
                                if (!empty($image_path) && file_exists(ROOTPATH . $row['image_path'])) {
                                    $img_path = base_url($row['image_path']);
                                } else {
                                    $img_path = base_url('public/img/blank-member.jpg');
                                }
                            ?>
                                <div class="col-lg-3">
                                    <div class="card">
                                        <img src="<?php echo $img_path ?>" alt="" class="img-fluid">
                                        <div class="mt-3">
                                            <h5>
