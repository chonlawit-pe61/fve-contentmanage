        ...
        <div class="custom-table-container mb-5 w-100">
            <div class="table-responsive">
                <table class="table" id="personnelTable">
                    ...
                    <tbody>
                        <?php if (!empty($information_successful)): ?>
                            <?php foreach ($information_successful as $key => $value): ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="fw-bold text-dark mb-1" style="font-size: 1.05rem;"><?= $value['information_successful_file_name'] ?></div>

                                    </td>
                                    <td class="text-center">
                                        <a href="<?= base_url($value['information_successful_file']) ?>"
                                            target="_blank"
                                            class="btn-view-file">
