        ...
        <div class="container px-4" style="display: unset;">
            ...
            <div class="row">
                <div class="col-12"> <!-- STRICT Full Width Column -->
                    ...
                    <?php if (!empty($repositoryType)): ?>
                        <?php foreach ($repositoryType as $index => $row): ?>
                            ...
                            <div class="law-card" data-aos="fade-up" data-aos-delay="<?= $index * 100 ?>">
                                ...
                                <div class="law-card-header">
                                    ...
                                    <?php $count = !empty($publishRepository[$row['id']]) ? count($publishRepository[$row['id']]) : 0; ?>
                                ...
                                <div class="law-items-wrapper">
                                    ...
                                    <?php if (!empty($publishRepository[$row['id']])): ?>
                                        <?php foreach ($publishRepository[$row['id']] as $key => $file): ?>
