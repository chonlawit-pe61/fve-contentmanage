    ...
    <div class="wave-header">
        <div class="header-content text-center" data-aos="zoom-in">
            <h1 class="contact-title" style="color: white; text-shadow: 2px 2px 4px rgba(0,0,0,0.3); font-size: 2.5rem; margin-bottom: 10px;">
                แผนพัฒนาการจัดการศึกษา สถานศึกษา
            </h1>
        ...
        <div class="custom-table-container mb-5 w-100">
            <div class="table-responsive">
                <table class="table" id="personnelTable">
                    ...
                    <tbody>
                        <?php if (!empty($publishEducationalDevelopment)): ?>
                            <?php foreach ($publishEducationalDevelopment as $key => $value): ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="fw-bold text-dark mb-1" style="font-size: 1.05rem;"><?= $value['publish_educational_development_file_name'] ?></div>

                                    </td>
                                    <td class="text-center">
                                        <a href="<?= base_url($value['publish_educational_development_file']) ?>"
                                            target="_blank"
                                            class="btn-view-file">
