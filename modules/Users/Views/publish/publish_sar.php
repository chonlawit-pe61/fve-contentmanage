        ...
        <div class="custom-table-container mb-5 w-100">
            <div class="table-responsive">
                <table class="table" id="personnelTable">
                    ...
                    <tbody>
                        <?php if (!empty($publishSar)): ?>
                            <?php foreach ($publishSar as $key => $value): ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="fw-bold text-dark mb-1" style="font-size: 1.05rem;"><?= $value['publish_sar_file_name'] ?></div>

                                    </td>
                                    <td class="text-center">
                                        <a href="<?= base_url($value['publish_sar_file']) ?>"
                                            target="_blank"
                                            class="btn-view-file">
