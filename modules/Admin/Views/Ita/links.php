...
<div class="card">
    <div class="card-body">
        ...
        <div class="card bg-light mb-4">
            <div class="card-body">
                <h6 class="card-title">เพิ่มลิงค์ใหม่</h6>
                <form action="<?= base_url('admin/ita/save_link') ?>" method="post" class="row g-3 align-items-end">
                    <input type="hidden" name="ita_subtopic_id" value="<?= $subtopic['id'] ?>">

                    <div class="col-md-5">
                        <label class="form-label">คำอธิบายลิงค์ (ข้อความที่แสดง)</label>
                        <input type="text" name="description" class="form-control" placeholder="เช่น ดาวน์โหลดไฟล์ PDF" required>
                    </div>
                    <div class="col-md-5">
