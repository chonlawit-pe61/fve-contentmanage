...
<div class="card shadow shadow-lg">
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-12 my-2">
                <a href="<?= base_url('admin/law/manage') ?>" class="btn btn-sm mb-1 px-4 fs-4  bg-primary-subtle text-primary float-start">
                    <i class="ti ti-plus"></i> เพิ่มกฏหมาย
                </a>
            </div>
...
<script>
    $(document).ready(function() {
        $('#table').DataTable({
            ...
            language: dtLanguage,
            ajax: {
                url: '<?= base_url('admin/law/ajax-table-laws') ?>',
                method: "POST"
            },
            columnDefs: [{
                targets: -1,
    ...
    function deleteLaw(id) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    method: "POST",
                    url: "<?= base_url('admin/law/delete-law') ?>",
                    data: {
                        id: id
                    },
                });
