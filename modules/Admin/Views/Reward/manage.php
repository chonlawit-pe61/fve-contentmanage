...
<div class="card shadow shadow-lg">
    <form action="<?= base_url('admin/reward/save-reward') ?>" method="POST" autocomplete="off" enctype="multipart/form-data" class="once-only">
        <!-- Hidden -->
        <input type="hidden" name="id" value="<?= (@$reward['id']) ? $reward['id'] : '' ?>">
        <div class="card-body">
            <div class="row">
                <div class="col-12 my-2">
                    <h3>ผลงานและความสำเร็จ</h3>
                </div>
                <div class="col-12 my-2">
                    <nav class="py-2" aria-label="breadcrumb" style="--bs-breadcrumb-divider: '/'">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?= base_url('admin/reward') ?>">ผลงานและความสำเร็จ</a></li>
                ...
                <div class="col-md-10 text-center">
                    <div>
                        <?php if (!empty($reward['image_path'])) { ?>
                            <img id="personel_image_display" src="<?= base_url($reward['image_path']) ?>" alt="" class="img-fluid border border-4 my-2" style="max-width: 175px;">
                        <?php } else { ?>
                            <img id="personel_image_display" src="<?= base_url('public/img/trophy.avif') ?>" alt="" class="img-fluid border border-4 my-2" style="max-width: 175px;">
                        <?php } ?>
                    </div>
            ...
            <div class="row justify-content-center my-2">
                ...
                <div class="col-md-10 my-2">
                    <div class="form-check py-2">
                        <input type="checkbox" class="form-check-input border border-2 border-primary" id="is_showing" name="is_showing" value="1" <?= (@$reward['is_showing'] == 1) ? 'checked' : '' ?>>
                        <label class="form-check-label" for="is_showing">แสดงผลงานนี้ในหน้าแรก</label>
                    </div>
                </div>
            </div>
